...
if (
    ...
    $query = "INSERT INTO students (first_name, last_name, email, gender, course, user_address, birthdate, date_created) VALUES (:firstName, :lastName, :email, :gender, :course, :address, :birthdate, NOW())";
